...
#Does your network still perform well?
#No, the network performs worse without ReLU: It loses state-of-the-art performance, becomes less robust to input variations, requires more epochs to converge, text accuracy drops, there is more erors, training becomes less stable -> loss fluctuates more